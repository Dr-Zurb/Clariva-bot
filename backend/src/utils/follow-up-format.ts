 ...
 * merges them. Keep in sync with `frontend/lib/cockpit/follow-up-format.ts`.
 */

import type { FollowUpUnit } from '../types/prescription';
...
/**
 * Normalize persisted `follow_up` TEXT into notes (strips output echoes).
 */
