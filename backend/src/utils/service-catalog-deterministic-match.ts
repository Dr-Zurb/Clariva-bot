 ...
 *
 * @see ../../../docs/Reference/product/learning/service-catalog-matching-stages.md — Stage A vs Stage B (LLM runs only if this returns null).
 */
 ...
 *
 * @see ../../../docs/Reference/product/learning/service-catalog-matching-stages.md — full narrative + FAQ
 */
