  ...
  try {
    ...
    if (error) {
      ...
      if (
        ...
        logger.error(
          ...
          'Database connection test failed - cannot reach database'
        );
        return false;
      }
      ...
      if (
        ...
        logger.error(
          { error: error.message, code: errorCode },
          'Database connection test failed - authentication error'
        );
        return false;
      }
      ...
      logger.warn(
        { error: error.message, code: errorCode },
        'Database connection test - unexpected error (assuming connection OK)'
      );
      return true;
    }
    ...
    if (
      ...
      logger.error(
        ...
        'Database connection test failed - network error'
      );
      return false;
    }
    ...
    logger.error(
      { error: error instanceof Error ? error.message : String(error) },
      'Database connection test - unexpected error'
    );
    return false;
  }
}
