 ...
 *
 * @see docs/Work/Daily-plans/April 2026/19-04-2026/Tasks/task-15-consultation-sessions-facade-and-schema.md
...
export async function createSession(
  ...
  // follow-up (see docs/Work/capture/inbox.md) rather than a keystone
  // change.
  //
