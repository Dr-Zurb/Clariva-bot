...
**Review cadence:** Weekly 30 min — sample routing mix per [OBSERVABILITY.md](../../../../docs/Reference/engineering/operations/OBSERVABILITY.md) (DM routing section). **Owner:** team on-call rotation or product ops lead (set in your roster).
