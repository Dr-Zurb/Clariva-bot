...
- [FRONTEND_ARCHITECTURE.md](../docs/Reference/engineering/architecture/FRONTEND_ARCHITECTURE.md) – Structure, app/, lib/
- [FRONTEND_STANDARDS.md](../docs/Reference/engineering/development/FRONTEND_STANDARDS.md) – Coding rules
- [FRONTEND_RECIPES.md](../docs/Reference/engineering/development/FRONTEND_RECIPES.md) – Patterns (e.g. cn(), env)
