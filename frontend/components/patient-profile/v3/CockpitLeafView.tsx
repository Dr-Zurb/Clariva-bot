...
import PaneFocusButton, { isFocusTargetForLeaf } from "./PaneFocusButton";
...
export default function CockpitLeafView({
  ...
  return (
    <div
      className="flex h-full min-h-0 flex-col overflow-hidden rounded-lg border border-border bg-card shadow-md"
    ...
    >
      ...
      <div className="relative min-h-0 flex-1">
        {/*
          Scrollport for stacked (vertical) splits: react-resizable-panels sets
