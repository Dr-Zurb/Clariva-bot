...
import {
  ...
  formatDateTime as formatDateTimePinned,
...
function formatDateTime(iso: string): string {
  return formatDateTimePinned(iso);
}
...
export default function AvailabilityPage() {
  ...
  const handleAddBlocked = async (e: React.FormEvent) => {
    ...
    const dateStr = blockedDate || todayLocalIso();
    let start: string;
    let end: string;
