  ...
  return (
    <div>
      ...
      <p className="mt-1 text-gray-600">
        Slot length, advance booking limits, business hours summary, cancellation policy, and booking buffers. Teleconsult
        prices are set under Services catalog; practice currency under Practice Info.
      </p>
