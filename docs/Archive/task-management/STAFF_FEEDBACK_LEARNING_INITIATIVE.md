...
**Architecture stance:** v1 is **structured-first** (human labels + deterministic aggregation + policy on structured features). **Optional** semantic similarity (embeddings / LLM) is a **later, gated** add-on — see [plan §1a](../Work/Daily-plans/April%202026/12-04-2026/plan-staff-feedback-learning-system.md#1a-structured-first-vs-optional-nl--ai-clarify-scope). **Patient NLU** in the existing matcher remains **orthogonal** (LLM where appropriate for open-ended text per [AI_BOT_BUILDING_PHILOSOPHY.md](../Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md)).

**Status:** Planning  
**Created:** 2026-04-12  
**Plan:** [plan-staff-feedback-learning-system.md](../Work/Daily-plans/April%202026/12-04-2026/plan-staff-feedback-learning-system.md)  
**Philosophy:** [AI_BOT_BUILDING_PHILOSOPHY.md](../Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md) §9  
**Data contract (v1):** [STAFF_FEEDBACK_LEARNING_DATA_CONTRACT.md](../Reference/product/learning/STAFF_FEEDBACK_LEARNING_DATA_CONTRACT.md) — gates learn-02+
...
| Order | Task |
|-------|------|
| 1 | [e-task-learn-01](../Work/Daily-plans/April%202026/12-04-2026/tasks/e-task-learn-01-privacy-and-data-contract.md) — Privacy charter + data contract (gates all implementation) |
| 2 | [e-task-learn-02](../Work/Daily-plans/April%202026/12-04-2026/tasks/e-task-learn-02-learning-store-and-ingest.md) — Learning store schema + ingest on staff resolution |
| 3 | [e-task-learn-03](../Work/Daily-plans/April%202026/12-04-2026/tasks/e-task-learn-03-shadow-evaluation-and-metrics.md) — Shadow mode + internal metrics (no behavior change) |
| 4 | [e-task-learn-04](../Work/Daily-plans/April%202026/12-04-2026/tasks/e-task-learn-04-opt-in-notification-autobook-policy.md) — Doctor notification + opt-in records before autobook |
| 5 | [e-task-learn-05](../Work/Daily-plans/April%202026/12-04-2026/tasks/e-task-learn-05-assist-ui-and-gated-autobook.md) — Assist UI + gated production autobook + audit |
...
4. **PHI minimization** — align [PRIVACY_BY_DESIGN.md](../Reference/engineering/compliance/PRIVACY_BY_DESIGN.md), [COMPLIANCE.md](../Reference/engineering/compliance/COMPLIANCE.md); no PHI in logs; retention/deletion paths documented.  
