...
**Phase 2 (migration):** tracked in `docs/Work/capture/inbox.md` as a Plan 03 follow-up.
...
6. If the migration uncovers a latent bug, log it to `docs/Work/capture/inbox.md`; do not fix it in the migration PR.
