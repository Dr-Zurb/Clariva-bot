...
- [STANDARDS.md](../../Reference/engineering/development/STANDARDS.md) - Middleware order and authentication rules
...
**Related Task:** [e-task-5-backend-improvements.md](../Work/Daily-plans/2026-01-20/e-task-5-backend-improvements.md)  
**Version:** 1.0.0
