...
| [complaint-schema-refinement-backlog.md](./complaint-schema-refinement-backlog.md) | Tiered backlog of common chief complaints to refine one-by-one (fields, chips, parser, catalog). |
...
**Status:** ✅ **Shipped (2026-06-03)** — all items `ST.1–ST.10` built; the whole-program close-gate (`subj-10`) PASSED with `cc`/`hopi` byte-parity (PDF/SMS/snapshot unchanged). See [`p3-polish` close-gate verdict](../../../Daily-plans/June%202026/03-06-2026/subjective-tab/p3-polish/Tasks/task-subj-10-integration-a11y-and-close-gate.md#-close-gate-verdict--passed-2026-06-03).
