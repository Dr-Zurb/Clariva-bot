...
**Scope Guard:**
- Expected files touched: docs/Reference/engineering/development/TESTING.md, backend/tests/unit/controllers/webhook-controller.test.ts; optionally docs/Reference/engineering/operations/EXTERNAL_SERVICES.md, backend/src/services/dead-letter-service.ts (comment only)
- Any expansion requires explicit approval

**Reference Documentation:**
- [TESTING.md](../../Reference/engineering/development/TESTING.md) - Test patterns and examples
- [ARCHITECTURE.md](../../Reference/engineering/architecture/ARCHITECTURE.md) - Health via health-service
...
- ✅ `docs/Reference/engineering/development/TESTING.md` - EXISTS; Option 2 references getHealthStatus (health-service has only checkDatabaseConnection)
...
- ✅ `docs/Reference/engineering/operations/EXTERNAL_SERVICES.md` - EXISTS; can add ENCRYPTION_KEY note
