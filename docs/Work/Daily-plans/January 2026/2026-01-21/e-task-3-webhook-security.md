...
- [WEBHOOKS.md](../../Reference/engineering/operations/WEBHOOKS.md) - Webhook security rules and idempotency strategy
- [RECIPES.md](../../Reference/engineering/development/RECIPES.md) - Webhook implementation patterns (R-WEBHOOK-001)
- [COMPLIANCE.md](../../Reference/engineering/compliance/COMPLIANCE.md) - Webhook security requirements (section H)
- [STANDARDS.md](../../Reference/engineering/development/STANDARDS.md) - PII redaction rules for webhooks
...
**Related Learning:** `docs/Archive/learning/2026-01-21/l-task-3-webhook-security.md` ✅ Created  
