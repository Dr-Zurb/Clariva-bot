...
- [STANDARDS.md](../../Reference/engineering/development/STANDARDS.md) - Zod for all external input; ValidationError for validation failures; services throw AppError
- [ARCHITECTURE.md](../../Reference/engineering/architecture/ARCHITECTURE.md) - Validation in controllers; business rules in services; flow logic in service layer (webhook path has no HTTP controller)
- [COMPLIANCE.md](../../Reference/engineering/compliance/COMPLIANCE.md) - Section B: data classification; Section C: consent before PHI; Section D: audit (metadata only, no PHI)
- [RECIPES.md](../../Reference/engineering/development/RECIPES.md) - R-VALIDATION-001: Zod schemas in utils/validation; phone regex `^\+?[1-9]\d{1,14}$` (E.164-like)
- [DB_SCHEMA.md](../../Reference/engineering/architecture/DB_SCHEMA.md) - patients table has name, phone, date_of_birth, gender; no reason_for_visit column (see Notes)
- [RLS_POLICIES.md](../../Reference/engineering/compliance/RLS_POLICIES.md) - RLS on patients; service role in worker
- [DEFINITION_OF_DONE.md](../../Reference/engineering/development/DEFINITION_OF_DONE.md) - Feature completion checklist
- [ERROR_CATALOG.md](../../Reference/engineering/development/ERROR_CATALOG.md) - ValidationError (400) for invalid field values
...
**Completed:** 2026-01-30  
**Related Learning:** `docs/Archive/learning/2026-01-30/l-task-4-patient-collection-flow.md`  
