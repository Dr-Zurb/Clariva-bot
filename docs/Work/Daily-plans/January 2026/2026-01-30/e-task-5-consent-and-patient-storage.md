...
- [STANDARDS.md](../../Reference/engineering/development/STANDARDS.md) - No PII in logs; audit with correlationId; Zod validation
- [ARCHITECTURE.md](../../Reference/engineering/architecture/ARCHITECTURE.md) - Services for business logic; flow in service/worker (webhook path has no HTTP controller)
- [COMPLIANCE.md](../../Reference/engineering/compliance/COMPLIANCE.md) - Section C: consent; Section D: audit; Section E: RLS; Section F: lifecycle/deletion
- [DB_SCHEMA.md](../../Reference/engineering/architecture/DB_SCHEMA.md) - Schema for consent and patients; update after migration
...
- [MIGRATIONS_AND_CHANGE.md](../../Reference/engineering/development/MIGRATIONS_AND_CHANGE.md) - Migration numbering; update DB_SCHEMA after migration
...
**Completed:** 2026-01-30  
**Related Learning:** `docs/Archive/learning/2026-01-30/l-task-5-consent-and-patient-storage.md`  
