...
- [STANDARDS.md](../../Reference/engineering/development/STANDARDS.md) - Services throw AppError; asyncHandler in controllers; no PII in logs
- [ARCHITECTURE.md](../../Reference/engineering/architecture/ARCHITECTURE.md) - Services contain business logic; no Express in services
- [COMPLIANCE.md](../../Reference/engineering/compliance/COMPLIANCE.md) - Section G: AI assistive only; PHI redaction; audit metadata only; no raw prompts/responses with PHI persisted
- [RECIPES.md](../../Reference/engineering/development/RECIPES.md) - Retry, caching, fallback patterns if documented
...
**Completed:** 2026-01-30  
**Related Learning:** `docs/Archive/learning/2026-01-30/l-task-2-intent-detection-service.md`  
