...
- [STANDARDS.md](../../Reference/engineering/development/STANDARDS.md) - Middleware order and authentication requirements
- [ARCHITECTURE.md](../../Reference/engineering/architecture/ARCHITECTURE.md) - Middleware order and project structure
- [RECIPES.md](../../Reference/engineering/development/RECIPES.md) - Authentication middleware pattern (R-AUTH-001)
- [COMPLIANCE.md](../../Reference/engineering/compliance/COMPLIANCE.md) - Audit logging requirements for auth events
- [API_DESIGN.md](../../Reference/engineering/architecture/API_DESIGN.md) - Authentication patterns
...
**Related Learning:** `docs/Archive/learning/2026-01-20/l-task-5-backend-improvements.md` (to be created)  
