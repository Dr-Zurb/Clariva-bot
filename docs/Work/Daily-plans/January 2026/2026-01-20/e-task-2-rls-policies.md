...
- [RLS_POLICIES.md](../../Reference/engineering/compliance/RLS_POLICIES.md) - Row-level security rules (authoritative)
- [DB_SCHEMA.md](../../Reference/engineering/architecture/DB_SCHEMA.md) - Database schema definitions
- [COMPLIANCE.md](../../Reference/engineering/compliance/COMPLIANCE.md) - Access control requirements
- [ARCHITECTURE.md](../../Reference/engineering/architecture/ARCHITECTURE.md) - Database usage patterns
...
- [x] 5.1 Test policies in Supabase
  ...
  - [ ] 5.1.3 Test with authenticated user (should see own data only) - **DEFERRED** (See [../../../capture/features/ops-platform/deferred-rls-testing-2026-01-20.md](../../../capture/features/ops-platform/deferred-rls-testing-2026-01-20.md))
  - [ ] 5.1.4 Test with service role (should see all data) - **DEFERRED** (See [../../../capture/features/ops-platform/deferred-rls-testing-2026-01-20.md](../../../capture/features/ops-platform/deferred-rls-testing-2026-01-20.md))
  - [ ] 5.1.5 Test with different user (should NOT see other user's data) - **DEFERRED** (See [../../../capture/features/ops-platform/deferred-rls-testing-2026-01-20.md](../../../capture/features/ops-platform/deferred-rls-testing-2026-01-20.md))
- [ ] 5.2 Verify compliance
  ...
  - [ ] 5.2.2 Verify service role restrictions - **DEFERRED** (See [../../../capture/features/ops-platform/deferred-rls-testing-2026-01-20.md](../../../capture/features/ops-platform/deferred-rls-testing-2026-01-20.md))
...
**Note:** Testing tasks 5.1.3, 5.1.4, 5.1.5, and 5.2 are deferred until frontend/user creation system is available. RLS policies have been executed in Supabase and are active. See [../../../capture/features/ops-platform/deferred-rls-testing-2026-01-20.md](../../../capture/features/ops-platform/deferred-rls-testing-2026-01-20.md) for detailed testing steps when ready.
...
**Related Learning:** `docs/Archive/learning/2026-01-20/l-task-2-rls-policies.md`  
