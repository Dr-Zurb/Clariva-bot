...
- [STANDARDS.md](../../Reference/engineering/development/STANDARDS.md) - Services architecture and error handling
- [ARCHITECTURE.md](../../Reference/engineering/architecture/ARCHITECTURE.md) - Service layer patterns
...
- [DB_SCHEMA.md](../../Reference/engineering/architecture/DB_SCHEMA.md) - Database schema
...
**Related Learning:** `docs/Archive/learning/2026-01-20/l-task-4-database-helpers.md`  
