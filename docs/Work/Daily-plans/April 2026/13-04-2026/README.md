...
**Purpose:** Systematic **read-through** of Clariva receptionist code against [AI_BOT_BUILDING_PHILOSOPHY.md](../../../Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md). This folder is for **review and planning**, not patient-facing copy.
