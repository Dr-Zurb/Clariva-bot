...
**Epic mapping (`docs/Archive/task-management/tasks/tm-bot-audit-*.md`):**
...
- Philosophy: [AI_BOT_BUILDING_PHILOSOPHY.md](../../../../../Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md)
