...
- `docs/Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md` (full)
- `docs/Reference/product/receptionist-bot/RECEPTIONIST_BOT_CONVERSATION_RULES.md` (exists? scan)
- `docs/Reference/product/receptionist-bot/RECEPTIONIST_BOT_DM_BRANCH_INVENTORY.md` (if exists)
- `docs/Reference/engineering/compliance/COMPLIANCE.md` — PHI in DM (skim sections relevant to bot)
- `docs/Reference/engineering/development/DECISION_RULES.md`
