...
**Reference:** [AI_BOT_BUILDING_PHILOSOPHY.md](../../../../../Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md)  
...
4. Split execution into **phases** in [../execution/README.md](../execution/README.md) and `docs/Archive/task-management/tasks/tm-bot-audit-*.md`.
