...
- [x] **6.2** Update **[RECEPTIONIST_BOT_DM_BRANCH_INVENTORY.md](../../../../../Reference/product/receptionist-bot/RECEPTIONIST_BOT_DM_BRANCH_INVENTORY.md)** (or equivalent) and **RECIPES.md** once stable.
...
| Docs | `docs/Reference/engineering/development/RECIPES.md`, branch inventory |
