...
- **COMPLIANCE:** No PHI in logs; patient ID in logs is still sensitive — avoid raw MRN in log lines ([COMPLIANCE.md](../../Reference/engineering/compliance/COMPLIANCE.md)).
- **CONTRACTS:** If a frontend or webhook consumer expects ID in an old field, version or coordinate the change ([CONTRACTS.md](../../Reference/engineering/architecture/CONTRACTS.md)).
...
- Booking flow reference: [APPOINTMENT_BOOKING_FLOW_V2.md](../../Reference/product/booking/APPOINTMENT_BOOKING_FLOW_V2.md)
- Deferred (separate): interim “please wait” DM — `docs/Work/deferred/`
