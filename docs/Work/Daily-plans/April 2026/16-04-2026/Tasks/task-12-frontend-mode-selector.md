...
7. **Tests.** React Testing Library (if the project's Jest setup is in place; otherwise Playwright — Task 07 captured the Jest gap in `docs/Work/capture/inbox.md`). At minimum:
