...
- **Auto-snapshot of catalog before applying "Fix all with AI"** — captured in `docs/Work/capture/inbox.md`; for v1 the doctor still hits Save explicitly.
...
docs/Work/capture/inbox.md                                             — UPDATE (parked items: catalog snapshot before fix-all, mixed-complaint catalog signal)
```
