...
- [x] All existing tests pass (no regressions) — 16/16 pre-existing matcher tests pass; unrelated pre-existing failure in `webhook-worker-characterization.test.ts` is captured in `docs/Work/capture/inbox.md`
