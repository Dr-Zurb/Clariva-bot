...
Add **durable storage** for learning examples (labels from staff actions) and an **ingest path** triggered when a staff review is **confirmed** or **reassigned** (and optionally other resolutions per policy). Store **only** fields allowed by **[STAFF_FEEDBACK_LEARNING_DATA_CONTRACT.md](../../../../../Reference/product/learning/STAFF_FEEDBACK_LEARNING_DATA_CONTRACT.md)** — implement against [DC-ALLOW](../../../../../Reference/product/learning/STAFF_FEEDBACK_LEARNING_DATA_CONTRACT.md#dc-allow) and [DC-DENY](../../../../../Reference/product/learning/STAFF_FEEDBACK_LEARNING_DATA_CONTRACT.md#dc-deny).
...
- [x] 5.1 [RECIPES.md](../../../../../Reference/engineering/development/RECIPES.md) §19; DC-RET in data contract.
...
- Migration: follow [MIGRATIONS_AND_CHANGE.md](../../../../../Reference/engineering/development/MIGRATIONS_AND_CHANGE.md).
