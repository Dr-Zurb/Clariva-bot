...
- Doctor notification patterns exist elsewhere (email, in-app) — reuse patterns from [RECIPES.md](../../../../../Reference/engineering/development/RECIPES.md).
...
- Copy must be **explainable** (align [AI_BOT_BUILDING_PHILOSOPHY.md](../../../../../Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md) — facts from DB, not LLM-invented counts).
