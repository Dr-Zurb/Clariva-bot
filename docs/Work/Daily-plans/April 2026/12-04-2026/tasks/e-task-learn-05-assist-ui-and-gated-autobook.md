...
**Status:** Pending  
**Change type:** Update existing matcher + inbox + conversation transitions — follow [CODE_CHANGE_RULES.md](../../../../process/CODE_CHANGE_RULES.md)
...
- [ ] 5.1 Update [RECIPES.md](../../../../../Reference/engineering/development/RECIPES.md) booking gate section.
...
- **Platform executes** — autobook must set state via same code paths as staff confirm ([AI_BOT_BUILDING_PHILOSOPHY.md](../../../../../Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md)).
