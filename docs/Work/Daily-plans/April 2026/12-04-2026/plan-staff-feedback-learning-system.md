...
- [STAFF_FEEDBACK_LEARNING_DATA_CONTRACT.md](../../../Reference/product/learning/STAFF_FEEDBACK_LEARNING_DATA_CONTRACT.md) — privacy / allowed fields (learn-01); cite `DC-*` section IDs
- [SERVICE_MATCH_PATTERN_KEY.md](../../../Reference/product/learning/SERVICE_MATCH_PATTERN_KEY.md) — deterministic `pattern_key` (learn-03)
- [SERVICE_MATCH_SHADOW_METRICS.md](../../../Reference/product/learning/SERVICE_MATCH_SHADOW_METRICS.md) — shadow vs staff agreement (learn-03)
- [AI_BOT_BUILDING_PHILOSOPHY.md](../../../Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md) — §9 learning alignment
...
- [PRIVACY_BY_DESIGN.md](../../../Reference/engineering/compliance/PRIVACY_BY_DESIGN.md), [COMPLIANCE.md](../../../Reference/engineering/compliance/COMPLIANCE.md)
...
| **Patient message understanding** (existing product) | Matcher / triage already use **LLM + structured output** where appropriate ([AI_BOT_BUILDING_PHILOSOPHY.md](../../../Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md)) — **separate** from this learning layer. | **Yes** — upstream of staff review, not replaced by learning. |
...
- **Mitigation:** **Default deny** for new PHI columns; **data minimization**; DPIA-style checklist for embeddings; align with [COMPLIANCE.md](../../../Reference/engineering/compliance/COMPLIANCE.md).
