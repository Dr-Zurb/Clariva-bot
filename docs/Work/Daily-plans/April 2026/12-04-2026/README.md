...
- Static catalog fields and one-off rules do not scale when patient language and visit-type signals are **open-ended** (see [AI_BOT_BUILDING_PHILOSOPHY.md](../../../Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md)).
...
4. **PHI creep** — Default learning store **no free-text patient content**; align with [PRIVACY_BY_DESIGN.md](../../../Reference/engineering/compliance/PRIVACY_BY_DESIGN.md) and [COMPLIANCE.md](../../../Reference/engineering/compliance/COMPLIANCE.md); regional retention and deletion.
