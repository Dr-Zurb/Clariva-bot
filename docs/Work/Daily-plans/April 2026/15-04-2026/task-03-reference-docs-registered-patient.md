...
- **Notes:** Keep short; avoid duplicating full booking flow ([APPOINTMENT_BOOKING_FLOW.md](../../../../Reference/product/booking/APPOINTMENT_BOOKING_FLOW.md))
...
### 1. Choose location
- [x] 1.1 Add `docs/Reference/product/patients-and-practice/PATIENT_REGISTRATION_AND_ROSTER.md` **or** a section under existing [APPOINTMENT_REASON_AND_NOTES.md](../../../../Reference/product/booking/APPOINTMENT_REASON_AND_NOTES.md) — pick one place and stick to it
- [x] 1.2 Add a “See also” link from [ARCHITECTURE.md](../../../../Reference/engineering/architecture/ARCHITECTURE.md) or [ONBOARDING.md](../../../../Reference/engineering/operations/ONBOARDING.md) if a natural anchor exists (no `docs/Reference/README.md` index in repo)
...
docs/Work/Daily-plans/April 2026/15-04-2026/README.md — optional “Docs” bullet under Phase C
```
