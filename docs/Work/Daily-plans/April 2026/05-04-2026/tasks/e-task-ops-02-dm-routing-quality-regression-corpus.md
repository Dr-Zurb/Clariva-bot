...
- [x] **Update existing** — observability queries, CI job, dashboard — per scope; follow [CODE_CHANGE_RULES.md](../../../../process/CODE_CHANGE_RULES.md) when touching app code

**Dependencies:**

- **e-task-dm-06** (optional but complementary) — classifier changes should add **explicit** log fields / dimensions for new signals.
- Existing: `logInstagramDmRouting`, `instagram_dm_routing` (see [OBSERVABILITY.md](../../../../../Reference/engineering/operations/OBSERVABILITY.md)).

---

## 🎯 Goals

1. **Golden corpus** — versioned **anonymized** transcripts (expected branch sequence + short notes). Stored under repo (e.g. `backend/tests/fixtures/dm-routing-golden/` or `docs/Work/.../fixtures/`) — **no real PHI**; synthetic or redacted.
...
- [x] 1.3 Cross-link from [05-04-2026 README](../README.md) and [OBSERVABILITY.md](../../../../../Reference/engineering/operations/OBSERVABILITY.md).
...
- [x] 3.1 Update [OBSERVABILITY.md](../../../../../Reference/engineering/operations/OBSERVABILITY.md) with **queries** and “healthy ranges” caveats.
...
```
docs/Work/Daily-plans/April 2026/05-04-2026/fixtures/   (or tests/fixtures — pick one)
docs/Reference/engineering/operations/OBSERVABILITY.md                               (section update)
