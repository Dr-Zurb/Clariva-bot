...
- [x] **Update existing** — `ai-service` (classify schema / prompts), `instagram-dm-webhook-handler.ts`, `reason-first-triage.ts` (thin shared helpers), tests; follow [CODE_CHANGE_RULES.md](../../../../process/CODE_CHANGE_RULES.md)
...
4. **Documentation**: short **Hybrid NLU policy** (this repo or `SILENT_FEE_ASSIGNMENT_POLICY` appendix): model for language; code for money and branch invariants. _(Not a standalone appendix yet; behavior documented in this task + [OBSERVABILITY.md](../../../../../Reference/engineering/operations/OBSERVABILITY.md) routing notes.)_
...
| Docs | `docs/Archive/task-management/`, this file |
