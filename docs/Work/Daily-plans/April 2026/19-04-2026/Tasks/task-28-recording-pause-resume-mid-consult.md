...
3. **Pause reason templates / quick-picks.** Free-text v1. A future UX pass might add quick-pick chips ("Patient stepped away", "Phone call interruption", "Technical issue") — captured in `docs/Work/capture/inbox.md` if doctors complain about repetitive typing.
