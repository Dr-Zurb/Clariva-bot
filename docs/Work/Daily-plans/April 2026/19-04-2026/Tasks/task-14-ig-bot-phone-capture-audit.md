...
**Audit-only path:**
- This task file (`docs/Work/Daily-plans/April 2026/19-04-2026/Tasks/task-14-ig-bot-phone-capture-audit.md`) — Decision log entry with measured rate + SQL query
