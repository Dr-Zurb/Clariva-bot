...
2. **Documents** a small matrix in code comments or `docs/Work/`:
...
- `docs/Reference/product/learning/service-catalog-matching-stages.md` — narrative + matrix table
...
2. `docs/Reference/product/learning/service-catalog-matching-stages.md` — new "Strict / flexible × resolved
