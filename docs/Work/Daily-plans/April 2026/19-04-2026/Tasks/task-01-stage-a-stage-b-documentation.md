...
1. **Developer doc** (choose one location; keep it discoverable):
   - Option A: `docs/Work/` short page, e.g. `service-catalog-matching-stages.md`, OR
...
- [x] Doc links to `service-catalog-matcher.ts` and deterministic Stage A module (`docs/Reference/product/learning/service-catalog-matching-stages.md` code map + `@see` in both modules).
...
|-------------|----------|
| Developer doc | `docs/Reference/product/learning/service-catalog-matching-stages.md` |
| Philosophy cross-link | `docs/Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md` (Related) |
...
| Inbox | `docs/Work/capture/inbox.md` |
