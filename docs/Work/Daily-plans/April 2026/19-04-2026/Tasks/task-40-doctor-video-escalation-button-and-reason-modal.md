...
- [x] **Captured in follow-ups per the existing frontend-test-harness inbox note** (see `docs/Work/capture/inbox.md` → Recurring follow-ups). When bootstrapped, tests should cover:
...
### Follow-ups (added to `docs/Work/capture/inbox.md`)
