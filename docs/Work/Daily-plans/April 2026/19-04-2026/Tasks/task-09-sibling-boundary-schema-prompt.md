...
- `docs/Reference/product/learning/service-catalog-matching-stages.md` — Stage B narrative + Phase 3 update
...
1. **Philosophical fit.** Project rule (`docs/Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md`): doctors fill `examples`; AI handles disambiguation. Options 1 + 2 add a *new* doctor-facing field that competes with `examples` for attention and grows the matcher contract long-term.
...
- (a) Shadow telemetry from the Apr 12 learning system (`docs/Work/Daily-plans/April 2026/12-04-2026/`) shows a recurring sibling-pair misroute that cannot be fixed by tuning the prompt rule.
...
- `docs/Reference/product/learning/service-catalog-matching-stages.md` — Phase 3 (hybrid) section + Last-updated bump
- `docs/Work/Daily-plans/April 2026/19-04-2026/Plans/plan-service-catalog-matcher-routing-v2.md` — Phase 3 acceptance ticked + status footer + schema-half defer rationale
- `docs/Work/capture/inbox.md` — Task 09 entry prepended
