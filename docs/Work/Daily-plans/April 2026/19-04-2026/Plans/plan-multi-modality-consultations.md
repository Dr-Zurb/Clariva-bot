...
> Each task gets a separate `task-NN-...md` file under `docs/Work/Daily-plans/April 2026/19-04-2026/Tasks/`. **All product decisions are locked as of 2026-04-19.** Task list is complete pending owner review + sequencing confirmation.
