...
This plan is a direct conversion of the 2026-04-17 DM patient-experience audit (see `docs/Work/capture/inbox.md` under "DM copy audit 2026-04-17" once filed, and the audit transcript in chat history). Each task below corresponds to one audit finding; each task stands on its own and can ship independently.
...
- Reference doc: [`docs/Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md`](../../Reference/product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md) — §"Patient-facing copy" lines up with every principle in this plan.
