...
**Scope trade-offs:**
- No locale variants — English only (the message today is English only). Task captures `docs/Work/capture/inbox.md` if we ever need a Hindi/Punjabi confirm-details variant.
