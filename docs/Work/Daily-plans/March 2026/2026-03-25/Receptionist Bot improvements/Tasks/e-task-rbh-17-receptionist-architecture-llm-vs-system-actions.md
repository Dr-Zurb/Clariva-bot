...
- `docs/Reference/product/receptionist-bot/RECEPTIONIST_BOT_CONVERSATION_RULES.md` — principle #2 already states this; keep in sync
...
- [x] 2.1 Inventory webhook branches: label each as **Understand** (AI only), **Decide** (code), **Say** (AI vs template). → `docs/Reference/product/receptionist-bot/RECEPTIONIST_BOT_DM_BRANCH_INVENTORY.md`
