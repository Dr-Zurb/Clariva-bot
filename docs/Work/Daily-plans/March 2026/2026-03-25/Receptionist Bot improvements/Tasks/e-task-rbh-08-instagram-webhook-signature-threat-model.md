...
**Current State:**
- ✅ **`docs/Reference/engineering/compliance/WEBHOOK_SECURITY.md`** — branch matrix, threat model, mitigations, staging checklist, re-audit triggers.
...
- [RECEPTIONIST_BOT_ENGINEERING.md](../../../Work/Daily-plans/March%202026/2026-03-25/Receptionist%20Bot%20improvements/RECEPTIONIST_BOT_ENGINEERING.md)
...
### 4. Publish
- [x] 4.1 New or extended section in WEBHOOKS.md or `docs/Reference/engineering/compliance/WEBHOOK_SECURITY.md` (project choice).
...
```
docs/Reference/engineering/compliance/WEBHOOK_SECURITY.md (new)
docs/Reference/engineering/operations/WEBHOOKS.md (Instagram exception + See Also)
docs/Work/.../RECEPTIONIST_BOT_ENGINEERING.md §6
