...
- [x] 4.2 Update [ARCHITECTURE.md](../../../Reference/engineering/architecture/ARCHITECTURE.md) brief note if module layout changed meaningfully.
...
docs/Reference/engineering/architecture/ARCHITECTURE.md
```
