...
**Current State:**
- ✅ **What exists:** Structured logging in `webhook-controller`, `webhook-worker`, `instagram-service`; some patterns in [OBSERVABILITY.md](../../../Reference/engineering/operations/OBSERVABILITY.md) for other domains.
...
- [x] ✅ 4.1 Update [OBSERVABILITY.md](../../../Reference/engineering/operations/OBSERVABILITY.md) with receptionist/webhook section and example queries. — **Completed: 2026-03-28**
