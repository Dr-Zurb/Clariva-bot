...
**Change Type:**
- [x] **Update existing** — `frontend/app/dashboard/appointments/*`, new components — [CODE_CHANGE_RULES.md](../../../../process/CODE_CHANGE_RULES.md)
...
- [PRACTICE_SETUP_UI.md](../../../../../Reference/product/patients-and-practice/PRACTICE_SETUP_UI.md)
