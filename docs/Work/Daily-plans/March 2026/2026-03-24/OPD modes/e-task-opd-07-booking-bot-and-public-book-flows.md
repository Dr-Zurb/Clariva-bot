...
- [APPOINTMENT_BOOKING_FLOW_V2.md](../../../../../Reference/product/booking/APPOINTMENT_BOOKING_FLOW_V2.md)
...
- [x] 4.1 **Session full** — stable code **`OPD_SESSION_FULL`** + user string ([ERROR_CATALOG.md](../../../../../Reference/engineering/development/ERROR_CATALOG.md)).
...
docs/Reference/product/booking/APPOINTMENT_BOOKING_BOT_FLOW.md (if flow changes materially — Doc Drift Guard)
```
...
- [x] **AI prompts** — no PHI leakage in external LLM if used; follow [AI_AGENT_RULES.md](../../../../../Reference/engineering/development/AI_AGENT_RULES.md) (copy is deterministic in webhook for booking links)
