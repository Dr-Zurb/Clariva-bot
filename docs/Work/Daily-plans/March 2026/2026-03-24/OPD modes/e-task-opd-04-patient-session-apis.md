...
**Scope Guard:** Prefer **GET** snapshot under `/api/v1/bookings/:id/session` or `/bookings/session/:token` — align with [API_DESIGN.md](../../../../../Reference/engineering/architecture/API_DESIGN.md) and [CONTRACTS.md](../../../../../Reference/engineering/architecture/CONTRACTS.md).

**Reference Documentation:**
- [SECURITY.md](../../../../../Reference/engineering/compliance/SECURITY.md) · [CONTRACTS.md](../../../../../Reference/engineering/architecture/CONTRACTS.md)
...
- [x] 2.3 Rate-limit per [RATE_LIMITING.md](../../../../../Reference/engineering/development/RATE_LIMITING.md).
...
docs/Reference/engineering/architecture/CONTRACTS.md (if schema documented here)
```
...
- `docs/Reference/engineering/architecture/CONTRACTS.md` — Patient OPD session section
