...
Close the OPD initiative with **push/in-app notifications** for delay, early invite, turn soon; **observability** (metrics/logs for mode, queue depth, ETA errors); **automated tests** (integration + critical e2e); and **documentation** updates: [DB_SCHEMA.md](../../../../../Reference/engineering/architecture/DB_SCHEMA.md), [APPOINTMENT_BOOKING_FLOW_V2.md](../../../../../Reference/product/booking/APPOINTMENT_BOOKING_FLOW_V2.md), [ARCHITECTURE.md](../../../../../Reference/engineering/architecture/ARCHITECTURE.md) if new modules — per [AI_AGENT_RULES.md](../../../../../Reference/engineering/development/AI_AGENT_RULES.md) Doc Drift Guard.
...
- ✅ **Observability:** structured log lines `opd_booking_total`, `opd_eta_computed_total`, `opd_queue_reinsert_total` ([OBSERVABILITY.md](../../../../../Reference/engineering/operations/OBSERVABILITY.md)).
- ✅ **Tests:** `opd-notification-hints.test.ts`; snapshot tests updated for `inAppNotifications`.
- ✅ **Docs:** [OPD_SUPPORT_RUNBOOK.md](../../../../../Reference/engineering/operations/OPD_SUPPORT_RUNBOOK.md), README OPD folder, [CONTRACTS.md](../../../../../Reference/engineering/architecture/CONTRACTS.md), [opd-systems-plan.md](./opd-systems-plan.md) §13.

**Scope Guard:** MVP = **polling** + snapshot hints; no Meta DM for OPD live status.

**Reference Documentation:**
- [OBSERVABILITY.md](../../../../../Reference/engineering/operations/OBSERVABILITY.md) · [TESTING.md](../../../../../Reference/engineering/development/TESTING.md)
...
- [x] 5.1 [OPD_SUPPORT_RUNBOOK.md](../../../../../Reference/engineering/operations/OPD_SUPPORT_RUNBOOK.md)
...
docs/Reference/engineering/operations/OBSERVABILITY.md, CONTRACTS.md, ARCHITECTURE.md, APPOINTMENT_BOOKING_FLOW_V2.md
docs/Reference/engineering/operations/OPD_SUPPORT_RUNBOOK.md
docs/Work/.../OPD modes/README.md, opd-systems-plan.md
```
