...
- [x] 4.1 Update [BOOKING_FOR_OTHERS_AND_APPOINTMENT_LIMITS.md](../../../Reference/product/booking/BOOKING_FOR_OTHERS_AND_APPOINTMENT_LIMITS.md) — mark implementation done
