...
- [BOOKING_FOR_OTHERS_AND_APPOINTMENT_LIMITS.md](../../../Reference/product/booking/BOOKING_FOR_OTHERS_AND_APPOINTMENT_LIMITS.md) — Design
- [APPOINTMENT_BOOKING_FLOW_V2.md](../../../Reference/product/booking/APPOINTMENT_BOOKING_FLOW_V2.md) — Flow
- [RECEPTIONIST_BOT_CONVERSATION_RULES.md](../../../Reference/product/receptionist-bot/RECEPTIONIST_BOT_CONVERSATION_RULES.md) — Intent map
...
- [x] 6.1 Update [RECEPTIONIST_BOT_CONVERSATION_RULES.md](../../../Reference/product/receptionist-bot/RECEPTIONIST_BOT_CONVERSATION_RULES.md) — add book_for_someone_else to intent map
- [ ] 6.2 Update [APPOINTMENT_BOOKING_FLOW_V2.md](../../../Reference/product/booking/APPOINTMENT_BOOKING_FLOW_V2.md) — add "Booking for someone else" flow variant (optional)
