...
**Change Type:**
- [x] **Update existing** — doctor settings, validation, types; follow [CODE_CHANGE_RULES.md](../../../../../process/CODE_CHANGE_RULES.md)
...
- [x] 5.3 **`docs/Reference/engineering/architecture/DB_SCHEMA.md`** updated (`service_offerings_json`, SFU-01).
