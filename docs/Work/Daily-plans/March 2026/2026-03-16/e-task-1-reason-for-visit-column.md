...
- [APPOINTMENT_REASON_AND_NOTES.md](../../../Reference/product/booking/APPOINTMENT_REASON_AND_NOTES.md) — Column semantics
- [MIGRATIONS_AND_CHANGE.md](../../../Reference/engineering/development/MIGRATIONS_AND_CHANGE.md) — Migration rules
- [DB_SCHEMA.md](../../../Reference/engineering/architecture/DB_SCHEMA.md) — Schema
...
- [ ] 6.1 Update `docs/Reference/engineering/architecture/DB_SCHEMA.md` — add `reason_for_visit` to appointments table
...
- [ ] Read all previous migrations (001–015) per [MIGRATIONS_AND_CHANGE.md](../../../Reference/engineering/development/MIGRATIONS_AND_CHANGE.md)
