...
- [APPOINTMENT_REASON_AND_NOTES.md](../../../Reference/product/booking/APPOINTMENT_REASON_AND_NOTES.md) — Column semantics and flow
- [DB_SCHEMA.md](../../../Reference/engineering/architecture/DB_SCHEMA.md) — Schema documentation
- [APPOINTMENT_BOOKING_FLOW_V2.md](../../../Reference/product/booking/APPOINTMENT_BOOKING_FLOW_V2.md) — Booking flow
