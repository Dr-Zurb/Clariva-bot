...
**Change Type:**
- [ ] **New feature**
- [x] **Update existing** — Change send flow to use per-doctor token; follow [CODE_CHANGE_RULES.md](../../../../process/CODE_CHANGE_RULES.md)
...
- [STANDARDS.md](../../../../../Reference/engineering/development/STANDARDS.md) - Error handling, no token in logs
