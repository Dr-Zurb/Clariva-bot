...
**Change Type:**
- [ ] **New feature**
- [x] **Update existing** — Replace OAuth flow; follow [CODE_CHANGE_RULES.md](../../../../process/CODE_CHANGE_RULES.md)
...
- [CODE_CHANGE_RULES.md](../../../../process/CODE_CHANGE_RULES.md) - Audit, impact, remove obsolete
- [STANDARDS.md](../../../../../Reference/engineering/development/STANDARDS.md) - asyncHandler, error handling, no token in logs
- [ARCHITECTURE.md](../../../../../Reference/engineering/architecture/ARCHITECTURE.md) - Service layer; no Express in services
- [COMPLIANCE.md](../../../../../Reference/engineering/compliance/COMPLIANCE.md) - No token/code in logs; audit
- [EXTERNAL_SERVICES.md](../../../../../Reference/engineering/operations/EXTERNAL_SERVICES.md) - Meta/Instagram API timeouts, retries
- [SECURITY.md](../../../../../Reference/engineering/compliance/SECURITY.md) - State/CSRF, env secrets
...
**When updating existing code:** (per [CODE_CHANGE_RULES.md](../../../../process/CODE_CHANGE_RULES.md))
