...
Run and document end-to-end testing of the complete MVP flow (Instagram message → bot → booking → payment → notifications → doctor dashboard). Ensure all tests and test data comply with [TESTING.md](../../Reference/engineering/development/TESTING.md) and [FRONTEND_TESTING.md](../../Reference/engineering/development/FRONTEND_TESTING.md): no real PHI, fake placeholders only, canonical API contracts in mocks.
...
**Current State:**
- ✅ **What exists:** Backend and frontend implemented (e-task-1–5); backend tests in `backend/tests/`; E2E runbook in `docs/Reference/engineering/development/testing/e2e-runbook.md`; test data compliance done.
...
- [TESTING.md](../../Reference/engineering/development/TESTING.md) - PII in tests (fake placeholders), canonical contracts
- [FRONTEND_TESTING.md](../../Reference/engineering/development/FRONTEND_TESTING.md) - Unit, integration, E2E; mocks per CONTRACTS
- [CONTRACTS.md](../../Reference/engineering/architecture/CONTRACTS.md) - API response shapes for mocks
...
- [x] 1.2 If E2E is manual: create a short runbook (steps, test accounts, env) in `docs/Reference/engineering/development/testing/` or task notes.
...
```
docs/Reference/engineering/development/testing/                    (optional - E2E runbook)
...
- **E2E runbook:** `docs/Reference/engineering/development/testing/e2e-runbook.md` – manual steps for Instagram → bot → booking → payment → notifications → doctor dashboard; prerequisites, test data rules, checklist.
