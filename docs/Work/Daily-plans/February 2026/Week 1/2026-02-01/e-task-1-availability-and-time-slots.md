...
- [STANDARDS.md](../../Reference/engineering/development/STANDARDS.md) - Zod for input; asyncHandler; successResponse
- [ARCHITECTURE.md](../../Reference/engineering/architecture/ARCHITECTURE.md) - Controller pattern; services handle logic
- [DB_SCHEMA.md](../../Reference/engineering/architecture/DB_SCHEMA.md) - availability, blocked_times, appointments
- [COMPLIANCE.md](../../Reference/engineering/compliance/COMPLIANCE.md) - No PII in logs; audit metadata only
- [RECIPES.md](../../Reference/engineering/development/RECIPES.md) - R-VALIDATION-001 Zod schema pattern
- [ERROR_CATALOG.md](../../Reference/engineering/development/ERROR_CATALOG.md) - ValidationError (400) for invalid query
- [TESTING.md](../../Reference/engineering/development/TESTING.md) - Fake placeholders (PATIENT_TEST, +10000000000) for tests
- [DEFINITION_OF_DONE.md](../../Reference/engineering/development/DEFINITION_OF_DONE.md) - Feature completion checklist (if present)
...
**Completed:** _2026-01-30_  
**Related Learning:** `docs/Archive/learning/2026-02-01/l-task-1-availability-and-time-slots.md`  
