...
- [FRONTEND_ARCHITECTURE.md](../../Reference/engineering/architecture/FRONTEND_ARCHITECTURE.md) - Layout structure; `components/layout/` for Header, Sidebar
- [FRONTEND_STANDARDS.md](../../Reference/engineering/development/FRONTEND_STANDARDS.md) - Tailwind, `cn()`, semantic HTML, accessibility
- [FRONTEND_RECIPES.md](../../Reference/engineering/development/FRONTEND_RECIPES.md) - F3 auth guard (existing); F5 `cn()` for classes
- [FRONTEND_COMPLIANCE.md](../../Reference/engineering/compliance/FRONTEND_COMPLIANCE.md) - No PII/PHI in DOM or logs; auth
- [DEFINITION_OF_DONE_FRONTEND.md](../../Reference/engineering/development/DEFINITION_OF_DONE_FRONTEND.md) - §1 Code/Structure, §3 Accessibility (focus, aria-current), §5 Security/Privacy
- [STANDARDS.md](../../Reference/engineering/development/STANDARDS.md) - TypeScript; structure
...
**See also:** [DEFINITION_OF_DONE_FRONTEND.md](../../Reference/engineering/development/DEFINITION_OF_DONE_FRONTEND.md) (full checklist before marking done).
...
**Related Learning:** `docs/Archive/learning/2026-02-03/l-task-3-dashboard-layout-and-navigation.md` (create when implementing)  
