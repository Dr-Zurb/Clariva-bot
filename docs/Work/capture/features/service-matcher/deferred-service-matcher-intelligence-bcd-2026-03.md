> **Migrated:** 2026-06-18 from `docs/Work/deferred/` → [`capture/features/service-matcher/`](.)
...
2. File a small PRD or task under `docs/Work/Daily-plans/` with acceptance criteria.
