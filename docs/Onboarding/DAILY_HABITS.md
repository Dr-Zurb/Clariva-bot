...
```
- Open today's task file (docs/Work/Daily-plans/YYYY-MM-DD/)
- Review subtasks
...
Check `docs/Work/Monthly-plans/` — are you on track?
...
- [../Work/process/TASK_MANAGEMENT_GUIDE.md](../Work/process/TASK_MANAGEMENT_GUIDE.md) — Task workflow
