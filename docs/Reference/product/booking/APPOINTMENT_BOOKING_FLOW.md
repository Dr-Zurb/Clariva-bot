# Appointment Booking Flow — Design Reference (legacy)

> **Legacy.** Canonical flow is [APPOINTMENT_BOOKING_FLOW_V2.md](./APPOINTMENT_BOOKING_FLOW_V2.md). Keep this doc for historical context only.
...
**Related:** [e-task-2: Appointment booking flow refinements](../../Work/Daily-plans/March%202026/2026-03-10/e-task-2-appointment-booking-flow-refinements.md)
...
- [RECEPTIONIST_BOT_CONVERSATION_RULES.md](../receptionist-bot/RECEPTIONIST_BOT_CONVERSATION_RULES.md)
- [DOCTOR_SETTINGS_PHASES.md](../patients-and-practice/DOCTOR_SETTINGS_PHASES.md)
- [e-task-2: Appointment booking flow refinements](../../Work/Daily-plans/March%202026/2026-03-10/e-task-2-appointment-booking-flow-refinements.md)
