...
- [RECEPTIONIST_BOT_CONVERSATION_RULES.md](../receptionist-bot/RECEPTIONIST_BOT_CONVERSATION_RULES.md) — Intent map
...
- [DB_SCHEMA.md](../../engineering/architecture/DB_SCHEMA.md) — appointments, patients
- [APPOINTMENT_BOOKING_FLOW_V2.md](./APPOINTMENT_BOOKING_FLOW_V2.md) — Flow
- [COMPLIANCE.md](../../engineering/compliance/COMPLIANCE.md) — No PHI in logs
