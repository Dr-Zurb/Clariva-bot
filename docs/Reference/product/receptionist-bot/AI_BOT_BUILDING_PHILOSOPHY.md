...
**Related:**
- [Receptionist re-architecture charter + migration (2026-05-30)](../../../Work/Daily-plans/May%202026/30-05-2026/receptionist-rearchitecture/plan-receptionist-rearchitecture-charter.md) — **the executable companion to this doc:** the frozen decision lock (DL-1→DL-12, including the constitution `Safety → Privacy/Consent → Truthful facts → Helpfulness → Conversion`), the target architecture (channel-agnostic engine + funnel state machine), and the phased plan that turns this philosophy into code. Per-phase batches: [program README](../../../Work/Daily-plans/May%202026/30-05-2026/receptionist-rearchitecture/README.md).
...
- [PRIVACY_BY_DESIGN.md](../../engineering/compliance/PRIVACY_BY_DESIGN.md), [COMPLIANCE.md](../../engineering/compliance/COMPLIANCE.md) — PHI, safety copy, consent
- [DECISION_RULES.md](../../engineering/development/DECISION_RULES.md) — when docs conflict, resolution order
...
- [ ] Did we add or extend a **regression test or corpus entry** for routing quality (see ops tasks under `docs/Work/Daily-plans`)?
...
| Rule | Why |
|------|-----|
| **Generalize, don’t memorize** | Prefer **structured** matcher outputs (reason codes, candidates, modalities, bucket flags) for “similar case.” **Do not** ship v1 learning that stores **raw patient** messages in new tables without a **privacy + legal** sign-off ([PRIVACY_BY_DESIGN.md](../../engineering/compliance/PRIVACY_BY_DESIGN.md)). |
...
| **Structured-first learning** | v1 **does not** require a learning-specific LLM: aggregation and policy match use **structured** fields + counts. **Optional** semantic similarity (embeddings / LLM) is **gated**. Open-ended **patient** text is still handled by the **existing** matcher NLU where appropriate — see [plan §1a](../Work/Daily-plans/April%202026/12-04-2026/plan-staff-feedback-learning-system.md#1a-structured-first-vs-optional-nl--ai-clarify-scope). |

**Plan:** [plan-staff-feedback-learning-system.md](../Work/Daily-plans/April%202026/12-04-2026/plan-staff-feedback-learning-system.md) — **tasks:** [e-task-learn-01](../Work/Daily-plans/April%202026/12-04-2026/tasks/e-task-learn-01-privacy-and-data-contract.md) … [e-task-learn-05](../Work/Daily-plans/April%202026/12-04-2026/tasks/e-task-learn-05-assist-ui-and-gated-autobook.md).
