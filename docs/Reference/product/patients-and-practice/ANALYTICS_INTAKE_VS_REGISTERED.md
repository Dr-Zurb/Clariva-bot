...
**Audience:** Product, data, engineering. **Privacy:** No PHI in metrics or log labels — see [COMPLIANCE.md](../../engineering/compliance/COMPLIANCE.md) and [OBSERVABILITY.md](../../engineering/operations/OBSERVABILITY.md) “Metrics Baseline.”
