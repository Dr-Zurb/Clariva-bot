...
**Audience:** Engineers, product, and support. **Scope:** What “registered” means for the **doctor dashboard Patients list**, versus ongoing bot **intake** (data collection, reminders, consent). This note does **not** replace the full booking narrative — see [APPOINTMENT_BOOKING_FLOW.md](../booking/APPOINTMENT_BOOKING_FLOW.md).
...
- **Context & principles:** [15-04-2026 daily README](../Work/Daily-plans/April%202026/15-04-2026/README.md)
- **List filter (MRN gate):** [task-01](../Work/Daily-plans/April%202026/15-04-2026/task-01-patients-list-mrn-filter.md)
- **Zero-fee / no-payment MRN:** [task-02](../Work/Daily-plans/April%202026/15-04-2026/task-02-mrn-zero-fee-booking-complete.md)
