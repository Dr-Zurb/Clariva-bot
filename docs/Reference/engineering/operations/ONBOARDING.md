...
**Related:** [ARCHITECTURE.md](../architecture/ARCHITECTURE.md) | [AI_BOT_BUILDING_PHILOSOPHY.md](../../product/receptionist-bot/AI_BOT_BUILDING_PHILOSOPHY.md) | [PATIENT_REGISTRATION_AND_ROSTER.md](../../product/patients-and-practice/PATIENT_REGISTRATION_AND_ROSTER.md) (who appears in doctor **Patients** vs early intake) | [README.md](../../../README.md) | [BUSINESS_PLAN.md](../../Archive/business/BUSINESS_PLAN.md)
...
1. Review monthly plan: `docs/Work/Monthly-plans/2025-01-09_1month_dev_plan.md`
2. Check today's tasks: `docs/Work/Daily-plans/YYYY-MM-DD/`
3. Read task file (e.g., `e-task-4-payment-integration.md`)
4. Check "Current State" to see what exists
5. Implement using [STANDARDS.md](../development/STANDARDS.md), [ARCHITECTURE.md](../architecture/ARCHITECTURE.md), [RECIPES.md](../development/RECIPES.md)
...
1. Create task file using `docs/Work/process/TASK_TEMPLATE.md`
2. Mark "Change type: New feature"
3. Follow task breakdown
4. Reference [STANDARDS.md](../development/STANDARDS.md) and [RECIPES.md](../development/RECIPES.md)
...
3. Follow [CODE_CHANGE_RULES.md](../../Work/process/CODE_CHANGE_RULES.md):
...
| What | Where |
|------|-------|
| Understand coding standards | [STANDARDS.md](../development/STANDARDS.md) |
| Learn the project structure | [ARCHITECTURE.md](../architecture/ARCHITECTURE.md) |
| Find implementation patterns | [RECIPES.md](../development/RECIPES.md) |
| Check compliance rules | [COMPLIANCE.md](../compliance/COMPLIANCE.md) |
| Add a webhook | [WEBHOOKS.md](./WEBHOOKS.md) |
| Design an API endpoint | [API_DESIGN.md](../architecture/API_DESIGN.md) |
| Write tests | [TESTING.md](../development/TESTING.md) |
| Understand errors | [ERROR_CATALOG.md](../development/ERROR_CATALOG.md) |
| Add external API | [EXTERNAL_SERVICES.md](./EXTERNAL_SERVICES.md) |
| Check database schema | [DB_SCHEMA.md](../architecture/DB_SCHEMA.md) |
| Set up RLS | [RLS_POLICIES.md](../compliance/RLS_POLICIES.md) |
| Run migrations | [MIGRATIONS_AND_CHANGE.md](../development/MIGRATIONS_AND_CHANGE.md) |
| Configure defaults | [SAFE_DEFAULTS.md](../development/SAFE_DEFAULTS.md) |
| Know when code is done | [DEFINITION_OF_DONE.md](../development/DEFINITION_OF_DONE.md) |
| Create a task | [Work/process/TASK_TEMPLATE.md](../../Work/process/TASK_TEMPLATE.md) |
| Change existing code | [Work/process/CODE_CHANGE_RULES.md](../../Work/process/CODE_CHANGE_RULES.md) |
...
- **Business context:** [BUSINESS_PLAN.md](../../../Archive/business/BUSINESS_PLAN.md)
- **Daily plans:** [Work/Daily-plans/](../../Work/Daily-plans/)
- **Coding rules:** [Reference/](../../Reference/README.md)
- **Task creation:** [Work/process/](../../Work/process/)
...
[DB_SCHEMA.md](../architecture/DB_SCHEMA.md) has full schema; `backend/migrations/` has SQL files.
...
No — use `env` from `config/env.ts` (validated with Zod). See [STANDARDS.md](../development/STANDARDS.md).

### "How do I add a new webhook?"
Follow [WEBHOOKS.md](./WEBHOOKS.md) and the R-WEBHOOK-001 pattern in [RECIPES.md](../development/RECIPES.md).
...
- [BUSINESS_PLAN.md](../../Archive/business/BUSINESS_PLAN.md) — Business context
- [STANDARDS.md](../development/STANDARDS.md) — Coding rules
- [COMPLIANCE.md](../compliance/COMPLIANCE.md) — Global compliance
