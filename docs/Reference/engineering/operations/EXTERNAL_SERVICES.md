...
- [COMPLIANCE.md](../compliance/COMPLIANCE.md) - Privacy and data handling requirements
- [SAFE_DEFAULTS.md](../development/SAFE_DEFAULTS.md) - Default timeout and retry values
- [STANDARDS.md](../development/STANDARDS.md) - Error handling and logging rules
- [RECIPES.md](../development/RECIPES.md) - Integration implementation patterns
...
**See:** [COMPLIANCE.md](../compliance/COMPLIANCE.md) "Global Privacy Baseline" section
...
**See:** [DB_SCHEMA.md](../architecture/DB_SCHEMA.md) for schema patterns
**See:** [RLS_POLICIES.md](../compliance/RLS_POLICIES.md) for RLS patterns
...
- **Rules checked 15 Sep 2026** ([private replies](https://developers.facebook.com/docs/instagram-platform/private-replies/), [error codes](https://developers.facebook.com/docs/messenger-platform/error-codes/)): one private reply per comment within 7 days; Live only during the broadcast; a further DM only after they reply, then 24h. Payload is `recipient.comment_id` + `message.text` (omit `messaging_type`). Graph `code` 10 + `2534022` / `2018278` / `2018065` = outside window. Do not tag automated sends `HUMAN_AGENT`.
- **Full Meta terms snapshots + clause-by-clause audit (15 Sep 2026):** [`compliance/meta-terms/2026-09-15/AUDIT.md`](../compliance/meta-terms/2026-09-15/AUDIT.md) — includes the Dev Policies §5 Healthcare clause (with counsel), the opt-out gap, and the Tech Provider contract duty. Engineering alignment: [`plan-meta-channel-align.md`](../../../Work/Product%20plans/plan-meta-channel-align.md).
- **Prescription on Instagram (MCA-DL-1, 15 Sep 2026):** IG gets a generic ready-notice + HMAC share URL only. Do not attach the PDF, images, or medicine list on Meta. Email still carries the artifact. If the share URL cannot be minted, skip IG (fail closed).
...
**See:** [WEBHOOKS.md](./WEBHOOKS.md) for webhook patterns; [DB_SCHEMA.md](../architecture/DB_SCHEMA.md) for payments table
...
**See:** [COMPLIANCE.md](../compliance/COMPLIANCE.md) "External AI" section
...
**See:** [COMPLIANCE.md](../compliance/COMPLIANCE.md) — no PII in logs; audit all notification events
...
**See:** [ERROR_CATALOG.md](../development/ERROR_CATALOG.md) for error classes
...
- [COMPLIANCE.md](../compliance/COMPLIANCE.md) - Privacy and data handling
- [SAFE_DEFAULTS.md](../development/SAFE_DEFAULTS.md) - Default timeout and retry values
- [STANDARDS.md](../development/STANDARDS.md) - Error handling and logging
