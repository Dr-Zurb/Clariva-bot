...
Alerts and checks required for production per [COMPLIANCE.md](../../compliance/COMPLIANCE.md) §J (Incident Response & Monitoring).  
**Related:** [OBSERVABILITY.md](../OBSERVABILITY.md) | [deployment-runbook.md](./deployment-runbook.md)
...
- **Endpoint:** `GET /health` (see [DEPLOYMENT.md](../DEPLOYMENT.md)).
