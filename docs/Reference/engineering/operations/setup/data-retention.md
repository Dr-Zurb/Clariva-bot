...
Retention policy and automation per [COMPLIANCE.md](../../compliance/COMPLIANCE.md) §F and §K (region-specific retention).  
**Related:** [DATA_RETENTION.md](../Reference/engineering/compliance/DATA_RETENTION.md) | [COMPLIANCE.md](../../compliance/COMPLIANCE.md)
