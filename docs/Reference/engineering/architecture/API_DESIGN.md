...
**Related Files:**
- [STANDARDS.md](../development/STANDARDS.md) - Coding rules and error handling
- [ARCHITECTURE.md](./ARCHITECTURE.md) - Project structure
- [RECIPES.md](../development/RECIPES.md) - Implementation patterns
- [CODING_WORKFLOW.md](../development/CODING_WORKFLOW.md) - Coding process
...
**See:** [STANDARDS.md](../development/STANDARDS.md) "Canonical Contracts" section for exact format.
...
**See:** [STANDARDS.md](../development/STANDARDS.md) for error handling details.
...
**See:** [COMPLIANCE.md](../compliance/COMPLIANCE.md) for RBAC and access control details.
...
**See:** [RECIPES.md](../development/RECIPES.md) for implementation details.
...
- [STANDARDS.md](../development/STANDARDS.md) - Error handling, validation rules
- [ARCHITECTURE.md](./ARCHITECTURE.md) - Project structure
- [RECIPES.md](../development/RECIPES.md) - Implementation patterns
- [CODING_WORKFLOW.md](../development/CODING_WORKFLOW.md) - Coding process
