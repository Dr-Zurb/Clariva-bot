...
- [DB_SCHEMA.md](../architecture/DB_SCHEMA.md) - Database schema and table definitions
- [ARCHITECTURE.md](../architecture/ARCHITECTURE.md) - Database usage patterns
...
- [DB_SCHEMA.md](../architecture/DB_SCHEMA.md) - Table definitions
- [ARCHITECTURE.md](../architecture/ARCHITECTURE.md) - Database usage patterns
- [COMPLIANCE.md](./COMPLIANCE.md) - Access control requirements