...
**Related:** [WEBHOOKS.md](../operations/WEBHOOKS.md) · [COMPLIANCE.md](./COMPLIANCE.md) · [RECEPTIONIST_BOT_ENGINEERING.md](../Work/Daily-plans/March%202026/2026-03-25/Receptionist%20Bot%20improvements/RECEPTIONIST_BOT_ENGINEERING.md) §6
...
| **Not accepted:** Logging full `req.body` on success or failure. | PHI/PII risk; see [STANDARDS.md](../development/STANDARDS.md). |
...
Normal pipeline: comment early branch, non-actionable short-circuit, `message_edit` skip, echo skip, dedup, idempotency, queue DM job, **200** + audit metadata. (Same as design in [WEBHOOKS.md](../operations/WEBHOOKS.md).)
