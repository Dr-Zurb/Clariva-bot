...
**Related:** [COMPLIANCE.md](./COMPLIANCE.md) | [SECURITY.md](./SECURITY.md) | [DB_SCHEMA.md](../architecture/DB_SCHEMA.md)
...
**Database:** Use `ON DELETE CASCADE` for foreign keys where appropriate (see [DB_SCHEMA.md](../architecture/DB_SCHEMA.md))
...
- [DB_SCHEMA.md](../architecture/DB_SCHEMA.md) — Database schema and foreign keys
