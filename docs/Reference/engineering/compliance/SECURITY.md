...
**Related:** [COMPLIANCE.md](./COMPLIANCE.md) | [STANDARDS.md](../development/STANDARDS.md) | [EXTERNAL_SERVICES.md](../operations/EXTERNAL_SERVICES.md)
...
**See:** [STANDARDS.md](../development/STANDARDS.md) for Zod patterns; sanitize-input middleware for DOMPurify usage.
...
- [ ] Security events logged (webhook signature failures, auth failures) — see [OBSERVABILITY.md](../operations/OBSERVABILITY.md)
...
- **Use raw request body** for signature verification (see [WEBHOOKS.md](../operations/WEBHOOKS.md))
...
- **See:** [WEBHOOKS.md](../operations/WEBHOOKS.md) for idempotency patterns
...
- [STANDARDS.md](../development/STANDARDS.md) — Zod validation, error handling
- [WEBHOOKS.md](../operations/WEBHOOKS.md) — Webhook signature and idempotency
- [RLS_POLICIES.md](./RLS_POLICIES.md) — Row-level security patterns
- [OBSERVABILITY.md](../operations/OBSERVABILITY.md) — Security event logging
