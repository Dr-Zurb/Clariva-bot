...
- [CONTRACTS.md](../architecture/CONTRACTS.md) - Error response format
- [RECIPES.md](./RECIPES.md) - Error handling patterns
- [STANDARDS.md](./STANDARDS.md) - Error mapping rules
- [OBSERVABILITY.md](../operations/OBSERVABILITY.md) - Error logging rules
...
- [STANDARDS.md](./STANDARDS.md) - Error mapping rules
- [OBSERVABILITY.md](../operations/OBSERVABILITY.md) - Error logging