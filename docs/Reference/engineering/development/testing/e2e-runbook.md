...
**Related:** [TESTING.md](../Reference/engineering/development/TESTING.md) (PII placeholders, canonical responses), [webhook-testing-guide.md](./webhook-testing-guide.md) (webhook tests), [e-task-6-e2e-testing-and-test-data-compliance.md](../Work/Daily-plans/2026-02-04/e-task-6-e2e-testing-and-test-data-compliance.md).
...
- **Patient data in tests:** Use placeholders only: `PATIENT_TEST`, `+10000000000`, `TEST_EMAIL@example.com` (see [TESTING.md](../Reference/engineering/development/TESTING.md)).
...
- **Automated tests:** Same placeholders; no real PHI; assert structure over raw values (see [TESTING.md](../Reference/engineering/development/TESTING.md)).
...
The frontend includes Playwright E2E specs for critical dashboard flows (per [FRONTEND_TESTING.md](../Reference/engineering/development/FRONTEND_TESTING.md)):
...
**Reference:** [e-task-6-e2e-testing-and-test-data-compliance.md](../Work/Daily-plans/2026-02-04/e-task-6-e2e-testing-and-test-data-compliance.md)
