...
- [CONTRACTS.md](../architecture/CONTRACTS.md) - Current API contracts (locked)
- [DB_SCHEMA.md](../architecture/DB_SCHEMA.md) - Current database schema
- [STANDARDS.md](./STANDARDS.md) - Coding standards
- [ARCHITECTURE.md](../architecture/ARCHITECTURE.md) - System structure
...
- [CONTRACTS.md](../architecture/CONTRACTS.md) - Contract versioning rules
- [DB_SCHEMA.md](../architecture/DB_SCHEMA.md) - Current schema
- [STANDARDS.md](./STANDARDS.md) - Coding standards
