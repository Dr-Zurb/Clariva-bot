...
**AI Agents MUST NOT:**
- ❌ Assume API response shapes - **MUST** use types aligned with [CONTRACTS.md](../architecture/CONTRACTS.md)
...
**Related Files:**
- [FRONTEND_ARCHITECTURE.md](../architecture/FRONTEND_ARCHITECTURE.md) - Structure and boundaries
- [FRONTEND_RECIPES.md](./FRONTEND_RECIPES.md) - Copy-pastable patterns
- [FRONTEND_TESTING.md](./FRONTEND_TESTING.md) - Testing strategy
- [FRONTEND_COMPLIANCE.md](../compliance/FRONTEND_COMPLIANCE.md) - Privacy and security
- [CONTRACTS.md](../architecture/CONTRACTS.md) - API response shapes
