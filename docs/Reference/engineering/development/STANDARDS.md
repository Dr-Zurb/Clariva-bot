...
**IMPORTANT: STANDARDS.md is the source of truth for coding rules** — only [COMPLIANCE.md](../compliance/COMPLIANCE.md) outranks it (legal/PHI). For the full precedence order when docs disagree, see [DECISION_RULES.md](./DECISION_RULES.md).
...
- [CONTRACTS.md](../architecture/CONTRACTS.md) - API response contracts (locked shapes)
- [CODING_WORKFLOW.md](./CODING_WORKFLOW.md) - Step-by-step coding process and pre-flight checklist
- [API_DESIGN.md](../architecture/API_DESIGN.md) - API design principles and conventions
- [TESTING.md](./TESTING.md) - Testing strategy, patterns, and best practices
- [ARCHITECTURE.md](../architecture/ARCHITECTURE.md) - Project structure and layer boundaries
- [RECIPES.md](./RECIPES.md) - Copy-pastable code patterns
- [COMPLIANCE.md](../compliance/COMPLIANCE.md) - Regulatory requirements
- [ERROR_CATALOG.md](./ERROR_CATALOG.md) - Error classes catalog
- [OBSERVABILITY.md](../operations/OBSERVABILITY.md) - Logging, metrics, tracing
- [DB_SCHEMA.md](../architecture/DB_SCHEMA.md) - Database schema
- [RLS_POLICIES.md](../compliance/RLS_POLICIES.md) - Row-level security policies
- [WEBHOOKS.md](../operations/WEBHOOKS.md) - Webhook handling
- [EXTERNAL_SERVICES.md](../operations/EXTERNAL_SERVICES.md) - External service integration patterns
...
**⚠️ IMPORTANT: See [CONTRACTS.md](../architecture/CONTRACTS.md) for complete API contracts (locked shapes).**
...
**See:** [CONTRACTS.md](../architecture/CONTRACTS.md) for complete API contracts, headers, and idempotency rules.
...
5. [API_DESIGN.md](../architecture/API_DESIGN.md) - API design principles
6. [TESTING.md](./TESTING.md) - Testing strategies
7. [ARCHITECTURE.md](../architecture/ARCHITECTURE.md)
8. [RECIPES.md](./RECIPES.md)
9. [COMPLIANCE.md](../compliance/COMPLIANCE.md)
...
**Reference:** [RECEPTIONIST_BOT_CONVERSATION_RULES.md](../../product/receptionist-bot/RECEPTIONIST_BOT_CONVERSATION_RULES.md).
...
**See Also:** [`CODING_WORKFLOW.md`](./CODING_WORKFLOW.md) for step-by-step coding process, [`API_DESIGN.md`](../architecture/API_DESIGN.md) for API design principles, [`TESTING.md`](./TESTING.md) for testing strategies, [`ARCHITECTURE.md`](../architecture/ARCHITECTURE.md), [`RECIPES.md`](./RECIPES.md), [`COMPLIANCE.md`](../compliance/COMPLIANCE.md), [`TASK_MANAGEMENT_GUIDE.md`](../../task-management/TASK_MANAGEMENT_GUIDE.md)
